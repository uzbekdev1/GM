...
-   Решение необходимо разместить в репозитории своего аккаунта на сайте
     [https://github.com](https://github.com/DQKrait/Kontur.GameStats) и
    отправить ссылку на почту <sww.cv@bk.ru>.
